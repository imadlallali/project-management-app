...
import { CheckSquare, Square, Trash2, ListTodo, FileText, Trophy } from 'lucide-react';

export default function Tasks({ tasks = [], onAdd, onDelete, onToggle, projectId }) {
                ...
                {tasks.length === 0 ? (
                    ...
                    <ul className="space-y-3 pb-4">
                        {tasks.map((task, index) => (
                            <li 
                                key={task.id} 
                                className={`task-item group transition-all duration-300 ${
                                    task.completed 
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-start gap-3">
                                            <button
                                                ...
                                                className={`w-5 h-5 border-2 rounded mt-0.5 flex items-center justify-center transition-all duration-300 cursor-pointer transform hover:scale-110 ${
                                                    task.completed 
                                            ...
                                            <div className="flex-1">
                                                <p className={`leading-relaxed break-words transition-all duration-300 ${
                                                    task.completed 
