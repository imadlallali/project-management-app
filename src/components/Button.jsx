export default function Button({
  ...
  const variants = {
    ...
    primary: "btn-primary focus:ring-orange-300",
    secondary: "btn-secondary focus:ring-orange-300",
    ghost: "btn-ghost focus:ring-orange-300",
    danger:
      "bg-red-600 hover:bg-red-700 text-white px-4 py-2 shadow-md focus:ring-red-500",
  };
